export default function Contact() {
  return (
    ...
    className='flex flex-col items-center h-screen w-screen'>
        <h1 className='pt-20 font-bold text-ivory text-8xl'>/CONTACT</h1>
        <h2 className='pt-16 md:pt-32 text-6xl font-extrabold tracking-wide text-lavender'> Say hello! </h2>
        <div className='flex flex-col md:flex-row justify-center w-full gap-4 md:gap-12 pt-12 md:h-1/4'>
            <div className='flex flex-col items-center justify-center align-middle md:w-2/12'>
                <div className='w-52'>
                ...
                <button 
                className='
                px-10 py-1 mt-12 md:mt-12 transition-all text-xl
